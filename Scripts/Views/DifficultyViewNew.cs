...
{
	public class DifficultyViewNew : MonoBehaviour 
	{
		[HideInInspector]
		...
		private void CenterVertically(iGUIElement element, float y)
		{
			...
			element.positionTo(element.positionAndSize.center,(new Vector2(element.positionAndSize.x, adjustedY)),0.25f,iTweeniGUI.EaseType.easeInOutQuint);
		}

		public void SetDifficulty(MiniGameDifficulty newDifficulty)
		{
//			Debug.LogWarning(newDifficulty.ToString());
