...
namespace Voltage.Story.Expressions
{
    ...
    public class NotEqualToOperator : IOperator
    {
		public bool Operate (IExpression left, IExpression right)	
		{
			...
			return left.Evaluate() != right.Evaluate();		// NOTE: Support this ???
//			if(left is Expression && right is Expression)	
//			{
//				return (left as Expression).Evaluate() == (right as Expression).Evaluate();		// NOTE: Support this ???
//			}
//			throw new ArgumentException ("EqualToOperator::Operate");
