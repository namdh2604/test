...
namespace Voltage.Common.DebugTool
{

	// http://wiki.unity3d.com/wiki/index.php?title=PopupList
	using UnityEngine;
	...
	public class ComboBox
	{
		...
		private bool isClickedComboButton = true;
